...
/// Retrieves project model results with optional vector and reranker integrations.
///
/// The crate defines the typed boundary and deterministic test implementations; production
/// embedding providers are external integrations that pass precomputed vectors through this API.
///
/// # Arguments
///
/// * `manifest` - Indexed project manifest.
