...
pub use retrieval::{
    plan_retrieval, retrieve, retrieve_with_boundaries, retrieve_with_boundaries_and_rerank_intent,
};
pub use retrieval_plan::{
    ...
    ProjectContextRerankIntentSourceSelection, ProjectContextRerankerBoundary,
    ProjectContextRerankerReadiness, ProjectContextRerankerUnavailableReason,
    ProjectContextRetrievalOptions, ProjectContextRetrievalPhaseDiagnostics,
    ...
    ProjectContextRetrievalPlan, ProjectContextRetrievalPlanDiagnostic,
    ProjectContextRetrievalPlanningOutcome, ProjectContextRetrievalQueryDiagnostics,
    ProjectContextRetrievalReadRequestSummary, ProjectContextRetrievalRefusal,
    ProjectContextRetrievalRefusalCode, ProjectContextRetrievalRequest,
    ProjectContextRetrievalSelectedSummary, ProjectContextReturnOrderItem,
    ProjectContextSemanticQueryOptions, ProjectContextTopKStatus,
...
pub use types::{
    ...
    ProvenanceCompletenessReport, RerankCandidate, RerankIntent, RerankIntentSource, RerankScore,
