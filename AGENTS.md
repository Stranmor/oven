...
Current status: project-model injection correctness, retrieval quality baseline, durable context-pack artifact persistence, redaction-safe search episode capture, artifact/episode evaluation with knowledge-graph linkage, and typed persisted external exact fact batch ingestion are implemented. The external fact boundary persists `external_fact_batches` plus `external_facts_fingerprint`; accepted exact facts participate in manifest identity through deterministic batch metadata/fingerprints covering source, source label, tool version, workspace root, source artifact fingerprint, and manifest baseline hash. Ingestion validates workspace-root match, reference provenance paths, duplicate in-batch symbol IDs, and external symbol conflicts before mutation, while preserving exact/heuristic confidence separation and forbidding live LSP/SCIP/compiler spawning in favor of fixture/precomputed typed facts. Implemented through `e47ad48e25b202eea222dc3c8f341e701f68dcb0`, `887cdf49e0fadc77b4d134216cb1863b3d510e42`, `9138efb5a4fcd37ecb656b76aac915dae669608e`, `3f7650b004eacd1248d7aefb88e636e16e138218`, `76fe7c0e474e1e477082c053ae3caf178d483e57`, `afad02a9f2f769c1ee4b14af2a94a663d7a199e2`, `cb10812ca75b3f89959bce3488884328fd8841f9`, `66cef5837d...`, `1fe1ebb07d6372c5a07cdb48a5efa332d4b68963`, `33e435bd41db049761323e99774ba9a4939b15df`, and current HEAD `51a31103a7b6de69316ea81eeee4acb21eef2670`. Verified with targeted regressions, `cargo test -p forge_project_model` (85 passed), `cargo test -p forge_main test_conversation` (25 passed), `cargo check -p forge_project_model -p forge_main`, `cargo check -p forge_project_model -p forge_services -p forge_app`, `git diff --check`, and critic PASS.
